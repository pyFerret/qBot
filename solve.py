...
class Solve:
    ...
    def manual(self, exec): # i put this in to help with putting in movesets (self, moves to execute) 
        self.moves = exec
        self.execute()
